...
# 2. Questions I Have
- How I can apply Agile in my own life

# 3. What I Found Challenging
- XP Programming in Agile

# 4. Code I Wrote Today
- I updated my website and make it work. The code I wrote today was all over the place however, I will reflect how I make my website live again
- For the context: My website was perfectly fine then after my vacation, I clicked on the website but it showed up 404 error.
- How I tackle on this:
    - I try to run the command "npm run build" and it didn't show any message about the website or the directory I'm working on
    - I check my Github repository to find out that the website is no longer live. Start googling the solution. 
    - A lot of answers are about trying to stop the workflow and re-run them all again. However, there's no option to stop the workflow like they mention.
    - I look up "deployment" with "Docusaurus" keyword as well, the find out that Docusarus is upgraded to version 3 while my website is version 2 so I doubt the issue must lay there. Therefore, I updated my Docusauruse and also React version to 18. 
    - The website isn't live although I can run it locally and there's no error message.
    - I try to deploy my website using another host, which is Netlify and I found out that my Github page is flagged as spam because Netlify denied to host my project from Github. 
    - When your Github account is flagged, your profi9le and repositories will be hidden, which mean they cannot be viewed publicly. 
    - After research about "How to make my Github account unflagged as spam, the only way is to contact Github support team"
    - I sent a ticket to the Github Support Team about my issue, they released my account the next morning. They answered that Github will check for accounts that need manual reviews and my account is one of those. I doubt it because I created 3-4 repositories in one day, which may be marked as suspicious activity
    - My Github account is back to normal, I try to deploy my website again and it work like normal. However, I had to switched the branch it deployed to gh-pages since when I tried to figure out what's wrong, I switched it to main instead.
